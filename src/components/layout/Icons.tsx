/** SVG line icons — stroke 1.5, round caps, no emojis */
...
export function IconCloud({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M7 18h11a4 4 0 000-8 5 5 0 00-9.8-1.3A4 4 0 007 18z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function IconChat({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M21 12a8 8 0 01-8 8H8l-5 3v-3a8 8 0 118-11z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconSunLogo({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <circle cx="12" cy="12" r="4" stroke="var(--sun)" strokeWidth="1.5" />
      <path
